...
dll-c: point_search.c point_alg.c dllmain.c
	gcc -c -DBUILDING_EXAMPLE_DLL dllmain.c point_search.c point_alg.c -O3
	gcc -shared -o solution.dll dllmain.o point_search.o point_alg.o -Wl,--out-implib,solution.a -O3

dll-c++: point_search.c point_alg.c
	g++ -c -DBUILDING_EXAMPLE_DLL dllmain.c point_search.c point_alg.c -O3
	g++ -shared -o solution.dll dllmain.o point_search.o point_alg.o -Wl,--out-implib,solution.a -O3
